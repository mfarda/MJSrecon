...
CONFIG = {
    ...
    'passive_data': {
        'important_extensions': {'.php', '.asp', '.aspx', '.jsp', '.jspx', '.ashx', '.phpx'},
        'max_workers': 20,
        'request_timeout': 10,
        'results_dir': 'passive_data_results',
        'files': {
            'merged_raw': 'merged_raw_urls.txt',
            'important_files': 'important_file_urls.txt',
            'live_important': 'live_important_urls.txt',
            'parameters_dir': 'parameters',
            'url_parameters': 'url_parameters.json',
            'all_parameters': 'all_parameters.txt'
        }
    },
    'fallparam': {
        'results_dir': 'fallparams_results',
        'max_workers': 20,
        'threads': 5,
        'files': {
            'detailed_results': 'detailed_parameter_results.json',
            'summary_results': 'parameter_summary.txt'
        }
    },
    'dirs': {
        'results': 'results',
